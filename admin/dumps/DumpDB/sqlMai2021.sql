...
-- Started on 2021-05-10 13:58:21
...
--
-- TOC entry 198 (class 1259 OID 113705)
...
--
-- TOC entry 2052 (class 2604 OID 112726)
...
--
-- TOC entry 2053 (class 2604 OID 113021)
...
--
-- TOC entry 2049 (class 2604 OID 112655)
...
--
-- TOC entry 2054 (class 2604 OID 113032)
...
--
-- TOC entry 2050 (class 2604 OID 112668)
...
--
-- TOC entry 2051 (class 2604 OID 112675)
...
--
-- TOC entry 2194 (class 0 OID 112723)
-- Dependencies: 192
...
--
-- TOC entry 2196 (class 0 OID 113018)
-- Dependencies: 194
...
--
-- TOC entry 2189 (class 0 OID 112652)
-- Dependencies: 186
...
--
-- TOC entry 2198 (class 0 OID 113029)
-- Dependencies: 196
-- Data for Name: commande; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.commande (id_com, id_prod, quantite) VALUES (11, 202, 2);


--
-- TOC entry 2192 (class 0 OID 112665)
-- Dependencies: 189
-- Data for Name: produit; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.produit (id_prod, nom, categorie, description, prix, image, reference) VALUES (202, 'SWITCH', 'console', 'La console Nintendo sortie en 2017', 299.990000000000009, 'switch.png', 'B1');
...
INSERT INTO public.produit (id_prod, nom, categorie, description, prix, image, reference) VALUES (301, 'Iphone 12', 'smartphone', 'Apple Iphone 12 5g 128 Gb Black', 949.990000000000009, 'I12.png', 'C1');
...
INSERT INTO public.produit (id_prod, nom, categorie, description, prix, image, reference) VALUES (303, 'Huawei P20', 'smartphone', ' Huawei P20 128 Go - Noir', 749.990000000000009, 'p20.jpg', 'C3');
...
INSERT INTO public.produit (id_prod, nom, categorie, description, prix, image, reference) VALUES (102, 'Lenovo Legion', 'pc', 'Core i5 2,5 GHz - SSD 240 Go + HDD 1 To - 8 Go - NVIDIA GeForce GTX 1050 QWERTZ', 1399.99000000000001, 'lenovo.jpg', 'A2');
INSERT INTO public.produit (id_prod, nom, categorie, description, prix, image, reference) VALUES (101, 'Acer Nitro', 'pc', 'Core i5 2,4 GHz - SSD 128 Go + HDD 1 To - 8 Go - NVIDIA GeForce GTX 1050 AZERTY', 995.950000000000045, 'axer.jpg', 'A1');
...
SELECT pg_catalog.setval('public.commande_id_com_seq', 11, true);
...
SELECT pg_catalog.setval('public.produit_id_prod_seq', 14, true);
...
--
-- TOC entry 2062 (class 2606 OID 112731)
...
--
-- TOC entry 2064 (class 2606 OID 113026)
...
--
-- TOC entry 2056 (class 2606 OID 112660)
...
--
-- TOC entry 2066 (class 2606 OID 113034)
...
--
-- TOC entry 2060 (class 2606 OID 112674)
...
--
-- TOC entry 2058 (class 2606 OID 113856)
...
--
-- TOC entry 2067 (class 2606 OID 113046)
...
-- Completed on 2021-05-10 13:58:24
