...
<div class="container">
   <div class="card text-center">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Vous êtes sur TechnoShop, ce site vend diverses technologies qui</p>
    ...
    <div class="card-group">
        <div class="card">
            <img src="./admin/images/pc.jpg" class="card-img-top" alt="pc">
            <div class="card-body">
                <h5 class="card-title">PC <i class="far fa-grin-alt red"></i></h5>
        ...
        <div class="card">
            <img src="./admin/images/console.png" class="card-img-top" alt="console">
            <div class="card-body">
                <h5 class="card-title">Console <i class="far fa-grin-alt red"></i></h5>
        ...
        <div class="card">
            <img src="./admin/images/tel.png" class="card-img-top" alt="tel">
            <div class="card-body">
